OC.L10N.register(
    ...
    "Set a default order for all users. This will be ignored, if the user has setup a custom order." : "Define um pedido padrão para todos os usuários. Isso será ignorado se o usuário definiu um pedido padrão.",
