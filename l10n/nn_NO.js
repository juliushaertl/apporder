OC.L10N.register(
    ...
    "Set a default order for all users. This will be ignored, if the user has setup a custom order." : "Vel ei standard rekkjefølgje for alle brukarane. Brukaren kan overstyra denne ved å velja ei anna rekkefølgje.",
