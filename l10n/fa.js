OC.L10N.register(
    ...
    "App Order" : "سفارش برنامه",
    "Set a default order for all users. This will be ignored, if the user has setup a custom order." : "یک سفارش پیش فرض برای همه کاربران تنظیم کنید. اگر کاربر سفارش سفارشی تنظیم کرده باشد ، این مورد نادیده گرفته می شود.",
