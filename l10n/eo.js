OC.L10N.register(
    ...
    "Set a default order for all users. This will be ignored, if the user has setup a custom order." : "Agordi defaŭltan ordon por ĉiuj uzantoj. Uzanto povos difini sian propran ordon kaj do ne sekvi la defaŭltan ordon.",
