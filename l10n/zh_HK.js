OC.L10N.register(
    ...
    "Force the default order for all users:" : "強制讓所有用戶使用預設順序：",
    "If enabled, users will not be able to set a custom order." : "若開啟，用戶將無法設定自訂順序。"
},
"nplurals=1; plural=0;");
