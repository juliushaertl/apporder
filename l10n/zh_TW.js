OC.L10N.register(
    ...
    "App Order" : "應用程式順序",
    "Set a default order for all users. This will be ignored, if the user has setup a custom order, and the default order is not forced." : "設定預設的順序給所有的使用者。這將被忽略，假如使用者有設定一個客製化的順序，且預設的順序不強制。",
    "Drag the app icons to change their order." : "拖曳應用程式的圖示來更改順序",
    "Force the default order for all users:" : "強制讓所有使用者用預設的順序:",
    "If enabled, users will not be able to set a custom order." : "若開啟，使用者將無法設定一個客製化的順序。"
},
"nplurals=1; plural=0;");
